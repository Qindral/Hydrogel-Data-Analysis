"""
MSD analysis (13 mg Hydrogel) using core modules only.
...
# Configuration
# -----------------------------
ROOT_PATH = Path(Path(r"E:\PhD Data Analysis\SPT 2025 II\Hydrogel Messung\13 mg C16"))

XML_FOLDERS = {
    20.0: [Path(r"E:\PhD Data Analysis\SPT 2025 II\Hydrogel Messung\13 mg C16\20 nm\Tracks_neu")],
    50.0: [Path(r"E:\PhD Data Analysis\SPT 2025 II\Hydrogel Messung\13 mg C16\50 nm\Tracks")],#Path(r"E:\PhD Data Analysis\SPT 2025 II\Hydrogel Messung\20mg C16\50 nm\50 nm 20 mg\Tracks")],
    100.0: [Path(r"E:\PhD Data Analysis\SPT 2025 II\Hydrogel Messung\13 mg C16\100 nm\Tracks")],
...
SAVE_PATH = None
SAVE_PATH = Path(f"E:\\PhD Data Analysis\\SPT 2025 II\\Hydrogel Messung\\13 mg C16\\Plots_{pd.Timestamp.now().strftime('%Y%m%d')}")
...
CACHE_FILE = Path(__file__).parent / "cache" / "msd_13mg_results.pkl"
